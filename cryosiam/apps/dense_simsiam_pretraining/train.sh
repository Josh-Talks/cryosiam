...
#SBATCH -C "gpu=A100|gpu=A40"               # specify the type of gpu you want
...
conda activate /g/kreshuk/talks/miniforge3/envs/cryosiam

# finally, your script goes here
python train.py --config-file-path config.yaml